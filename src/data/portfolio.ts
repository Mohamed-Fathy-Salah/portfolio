...
export const education: Education[] = [
    {
        ...
        details: [
            'Cumulative GPA: 4.0 / 4.0 (Grade: Distinction with Honors)',
            'Ranked 1st out of the entire graduating class.',
        ]
    }
];
...
export const experiences: Experience[] = [
    {
        ...
        details: [
            'Payment Service Optimization: Reduced execution time by resolving race conditions, parallelizing payments, and optimizing complexity to O(n log n).',
            'Rule Engine Optimization (ValU): Improved execution time by 350x via precompiling rules, lazy evaluation, and vertical slicing.',
            'Distributed Transactions: Implemented Saga Pattern for consistent distributed transaction management.',
            'Database Optimization: Replaced N+1 queries, added Redis caching, and applied table slicing (70% load reduction).',
            'Data & Workflow Migration: Automated migration of 100,000+ records and old workflows prior to go-live.',
            'Mentorship & Leadership: Led code reviews, mentored juniors, and authored automation scripts.'
        ],
    ...
    },
    {
        ...
        details: [
            'Developed JavaScript automation scripts to streamline repetitive tasks.',
            'Built and deployed scalable backend architectures for various clients.'
        ],
